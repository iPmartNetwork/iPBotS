...
<p align="center">
  <img src="https://img.shields.io/badge/نسخه-1.0.0-blue?style=flat-square" alt="Version">
...
| زیرمجموعه | دعوت دوستان، کسب پورسانت |
...
| مدیریت کاربران | جستجو، مسدود، شارژ، ارسال پیام |
| مدیریت سرورها | افزودن/ویرایش/تست/حذف سرور VPN |
| مدیریت پلن‌ها | ساخت پلن، دسته‌بندی، قیمت‌گذاری |
